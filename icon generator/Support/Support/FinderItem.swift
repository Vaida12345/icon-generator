...
class FinderItem: CustomStringConvertible, Identifiable, Equatable {
    ...
    static func createIcon(at file: FinderItem, option: String, progress: ((_ progress: Double)->Void), completion: (()-> Void)) {
        ...
        file.iteratedOver { child in
            ...
            if option == "Normal" {
                ...
                let folder = "AppIcon.appiconset_\(finishedCounter)"
                FinderItem(at: "\(path2[path2.startIndex..<path2.lastIndex(of: "/")!])/\(folder)").generateDirectory(isFolder: true)
                if option == "Xcode Mac" {
                    _ = shell([
                    """
                    cd \(path2[path2.startIndex..<path2.lastIndex(of: "/")!])
                    
                    sips -z 16 16       \(file) --out \(folder)/icon_16x16.png
                    sips -z 32 32       \(file) --out \(folder)/icon_16x16@2x.png
                    sips -z 32 32       \(file) --out \(folder)/icon_32x32.png
                    sips -z 64 64       \(file) --out \(folder)/icon_32x32@2x.png
                    sips -z 128 128     \(file) --out \(folder)/icon_128x128.png
                    sips -z 256 256     \(file) --out \(folder)/icon_128x128@2x.png
                    sips -z 256 256     \(file) --out \(folder)/icon_256x256.png
                    sips -z 512 512     \(file) --out \(folder)/icon_256x256@2x.png
                    sips -z 512 512     \(file) --out \(folder)/icon_512x512.png
                    sips -z 1024 1024   \(file) --out \(folder)/icon_512x512@2x.png
                    """
                    ])
                    let manifestURL = Bundle.main.url(forResource: "Mac", withExtension: "json")!
                    try! FinderItem(at: manifestURL).copy(to: "\(path2[path2.startIndex..<path2.lastIndex(of: "/")!])/\(folder)/Contents.json")
                } else if option == "Xcode iPhone" {
                    _ = shell([
                    """
                    cd \(path2[path2.startIndex..<path2.lastIndex(of: "/")!])
                    
                    sips -z 16 16       \(file) --out \(folder)/icon_16x16@1x.png
                    sips -z 32 32       \(file) --out \(folder)/icon_16x16@2x.png
                    sips -z 20 20       \(file) --out \(folder)/icon_20x20@1x.png
                    sips -z 40 40       \(file) --out \(folder)/icon_20x20@2x.png
                    sips -z 60 60       \(file) --out \(folder)/icon_20x20@3x.png
                    sips -z 29 29       \(file) --out \(folder)/icon_29x29@1x.png
                    sips -z 58 58       \(file) --out \(folder)/icon_29x29@2x.png
                    sips -z 87 87       \(file) --out \(folder)/icon_29x29@3x.png
                    sips -z 32 32       \(file) --out \(folder)/icon_32x32@1x.png
                    sips -z 64 64       \(file) --out \(folder)/icon_32x32@2x.png
                    sips -z 40 40       \(file) --out \(folder)/icon_40x40@1x.png
                    sips -z 80 80       \(file) --out \(folder)/icon_40x40@2x.png
                    sips -z 120 120       \(file) --out \(folder)/icon_40x40@3x.png
                    sips -z 120 120       \(file) --out \(folder)/icon_60x60@2x.png
                    sips -z 180 180       \(file) --out \(folder)/icon_60x60@3x.png
                    sips -z 76 76       \(file) --out \(folder)/icon_76x76@1x.png
                    sips -z 152 152       \(file) --out \(folder)/icon_76x76@2x.png
                    sips -z 167 167       \(file) --out \(folder)/icon_83.5x83.5@2x.png
                    sips -z 128 128     \(file) --out \(folder)/icon_128x128@1x.png
                    sips -z 256 256     \(file) --out \(folder)/icon_128x128@2x.png
                    sips -z 256 256     \(file) --out \(folder)/icon_256x25@1x6.png
                    sips -z 512 512     \(file) --out \(folder)/icon_256x256@2x.png
                    sips -z 512 512     \(file) --out \(folder)/icon_512x512@1x.png
                    sips -z 1024 1024   \(file) --out \(folder)/icon_512x512@2x.png
                    sips -z 1024 1024   \(file) --out \(folder)/icon_1024x1024@1x.png
                    """
                    ])
                    let manifestURL = Bundle.main.url(forResource: "iPhone", withExtension: "json")!
                    try! FinderItem(at: manifestURL).copy(to: "\(path2[path2.startIndex..<path2.lastIndex(of: "/")!])/\(folder)/Contents.json")
                }
            }
            
            finishedCounter += 1
            progress(Double(finishedCounter) / Double(totalItemsCount))
        }
